# Scans a queried token using Predictor, serves as a layer between Feature extraction module and Prediction module.
# It is located in a /prediction_module directory, since the app is too small to introduce a separate middle layer. However,
# in case of scaling this functionality should move between feature extraction and prediction modules and UI.
